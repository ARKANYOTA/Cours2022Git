...
3) 
Le traitement chimique utilis� lors de l'exploitation du lithuim contamine l'eau environnante et la rend non potable. Les sels non exploit�s sont rej�t�s dans le milieu, rendant aussi l'eau aux alentours imporpore � la consomation? Ceci a un impact sur les humains, mais aussi sur les animaux. La biodiversit�est manac" dans la meusure ou toute forme de vie disparait autour des �tendues d'eau poillu�es. De plus, la nappe phr�atique est r�duite du fait du pompage et de la forte �vaporation de l'eau dans les bbassons. Il y a donc des cons�quences � la fois qualitative et quantitative sur l'au disponible.
Enfin, l'utilisation de pompes �met des gaz � effet de serre par la mobusions du diesel.

12 p 142)

Avantages;
- Aucune polluants utilis�
- Un nombre de cycle de vie plus �l�v�e
- Pas de dangers grave, sauf un d�gagment de chaleur

Incovegnats:
- Un cout plus �l�v�e au Wh
- Moins d'�nergie stock�e Wh au kg que le Li-ion et Li-Po

14 p 143)

```     
         radiative                electrique
[Soleil]----> (panneaux solaires) ---> [batteries]
                        |         \--> [systeme de gidage]
                        |         electrique
               pertes d'�nergie
               thermique
...
2) P_a = 1370 * 33.6 = 46 032 W

P_u = P_a * \nu = 46032 * 0.17 = 7825.44 W

b) 
Pbat = 6,9kW
Pu = Psg + Pbat
Pbat = Pu-Psg = 7,8 * 10^3 - 900 = 6 900 W

P = U*I
 
 3) 
I = P/U = 900 / 57,6 = 15,6A
